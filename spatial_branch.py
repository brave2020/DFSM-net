...
def matimage_loader(path):
    ...
    if "imgPAN" in matimage:
        arryimage=  np.float32((matimage['imgPAN']))
...
def train(IQA_model, Classification_model, IQA_optimizer, Classification_optimizer, train_loader, test_loader, start_epoch):
    ...
    for epoch in range(start_epoch + 1, args.epochs + 1):
        ...
        train_log_filename = "xiaorong_spatial_train_log.txt"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--database', default='1IKONOS', type=str,
                        help='database name ')
    # model info
    parser.add_argument('--model', default='Spatial-FR-new', type=str,
                        help='model name ')
    parser.add_argument('--pp', default='0', type=str,
                        help=' ')

    parser.add_argument("--fus_dir", type=str,
                        default='F:\\2-DataSet\\PAN_MS_fuse_image\\mat_datas\\5NMF_PAN\\5WV2\\',
                        help="fus image path.")

    parser.add_argument("--hs_ms_dir", type=str,
                        default='F:\\2-DataSet\\DOMS_data\\1Satellite_sensor_data\\Data_set\\5WV2\\PAN_1024\\',
                        help="HS_MS path.")

    parser.add_argument("--DMOS_dir", type=str,
                        default='F:\\2-DataSet\\DOMS_data\\4DMOS\\2空间\\5WV2.mat',
                        help="DMOS path.")

    parser.add_argument("--Index_dir", type=str,
                        default='F:\\2-DataSet\\DOMS_data\\4DMOS\\Index500.mat',
                        help="index path.")
